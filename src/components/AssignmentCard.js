...
import placeholder from '../assets/subject-placeholder.svg';
  ...
  return (
    <div className={`card ${a.status === 'Late' ? 'border-danger' : ''}`}>
      <div className="card-body d-flex gap-3 align-items-start">
        <img src={a.image || placeholder} alt={a.subject} className="assignment-thumb" />
        <div className="flex-grow-1">
          ...
          <p className="mt-2 mb-2">{a.description}</p>
          {a.attachment && (
            <div className="mb-2">
              <a className="btn btn-sm btn-outline-secondary me-2" href={a.attachment.data} download={a.attachment.name}>Download</a>
            </div>
          )}
